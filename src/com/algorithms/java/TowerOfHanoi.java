...
N (number of discs), from (The rod number from which we move the disc), to (The rod number to which we move the disc),
 ...
 (See the example for the format of the output) as well as return the count of total moves made. The total number of moves are printed by the driver code.
...
public class TowerOfHanoi {
    ...
    public static void main (String[] args) {
        towerOfHanoi(3, "Source Rod", "Destination Rod", "Helper Rod");
